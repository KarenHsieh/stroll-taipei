...
describe("toDisplayTime — interprets the input instant as Asia/Taipei wall-clock regardless of process TZ", () => {
  it("UTC instant 05:00 (Asia/Taipei Thursday 13:00) renders as 下午 1 點", () => {
    const taipeiThursdayAfternoon = new Date("2026-05-28T05:00:00Z");
    expect(toDisplayTime(taipeiThursdayAfternoon)).toBe("下午 1 點");
  });

  it("UTC instant 16:05 (Asia/Taipei Friday 00:05) renders as 約凌晨 12 點", () => {
    const taipeiFridayJustAfterMidnight = new Date("2026-05-28T16:05:00Z");
    expect(toDisplayTime(taipeiFridayJustAfterMidnight)).toBe("約凌晨 12 點");
  });
});
