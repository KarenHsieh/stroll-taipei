...
describe("validateAttraction — field-level violations", () => {
  it.each([
    ...
    ["lat outside Taipei", { lat: 30.0 }, "lat: must be within Taipei bounds"],
    ["lng outside Taipei", { lng: 100.0 }, "lng: must be within Taipei bounds"],
...
describe("validateAttraction — tag pool", () => {
  ...
  it("rejects a tag outside the pool with field path and value", () => {
    ...
    expectErrorMatch(result, "tags[1]: '火鍋' is not in tag pool");
  });
});
